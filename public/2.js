...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      baseUrlEdit: "/edit/",
      baseUrlDelete: "/manager/deletemap/",
      baseUrlAdd: "/manager/add"
    };
  }
});
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _vm._l(_vm.$store.getters.maps, function(map, index) {
        return _c(
          "div",
          {
            staticStyle: {
          ...
          [
            _c(
              "a",
              {
                ...
                attrs: { href: _vm.baseUrlEdit + map.map_id }
              },
              [_vm._v("\n            " + _vm._s(JSON.parse(map.config).title))]
            ),
            _vm._v(" "),
            _c(
              "a",
              {
                ...
                attrs: { href: _vm.baseUrlDelete + map.map_id }
              },
              [_vm._v("Удалить")]
            )
          ]
